...
END:VCARD
        ...
        formatPhoneNumber: {
            ...
            value(phone) {
                ...
                // Normalize first
                phone = conn.normalizePhoneNumber(phone);
                if (!phone) return '';
                
                // Format untuk display: 62 812-3456-7890
                if (phone.length === 12) {
        ...
        isValidIndonesianPhone: {
            ...
            value(phone) {
                ...
                // Validasi panjang dan prefix Indonesia
                const validLength = phone.length >= 10 && phone.length <= 15;
                const validPrefix = phone.startsWith('628') || 
                                   phone.startsWith('627') || 
                                   phone.startsWith('629');
...
export function protoType() {
     ...
     * @returns {String}
     */
    String.prototype.normalizePhone = function normalizePhone() {
     ...
     * @returns {Boolean}
     */
    String.prototype.isValidIndonesianPhone = function isValidIndonesianPhone() {
